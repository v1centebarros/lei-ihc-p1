        ...
        <div className="pt-3 w-60 min-h-screen shadow-md bg-light-gray px-1 relative">
                ...
                {defaultOptions.map((item,index) => {
                    return (
                        <Link key={index} to={item.path}>
                            <li className="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-soft-black text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-soft-red transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="dark">
                            {item.icon}
            ...
            <ul className="relative">
                {userOptions.map((item,index) => {
                    return (
                        <Link key={index} to={item.path}>
                            <li className="flex items-center text-sm py-4 px-6 h-12 text-soft-black text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-soft-red transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="dark">
